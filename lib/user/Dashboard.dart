                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      MenuWidget(redirect: TermsCondition(code: 'apar'), img: 'assets/img/apar.png', title: "Inspeksi APAR & APAB", desc: "Alat Pemadam Api Ringan & Alat Pemadam Api Berat"),
                      MenuWidget(redirect: TermsCondition(code: 'hydrantOHB'), img: 'assets/img/hydrant.png', title: "Inspeksi Hydrant OHB", desc: "Hydrant Outdoor (Luar Gedung)"),
                      MenuWidget(redirect: TermsCondition(code: 'hydrantIHB'), img: 'assets/img/hydrant.png', title: "Inspeksi Hydrant IHB", desc: "Hydrant Intdoor (Dalam Gedung)"),
                      MenuWidget(redirect: TermsCondition(code: 'P3K'), img: 'assets/img/p3k.png', title: "Inspeksi Kotak P3K", desc: "Kotak P3K"),
                      MenuWidget(redirect: TermsCondition(code: 'exit'), img: 'assets/img/emergency_exit.png', title: "Inspeksi Jalur Evakuasi", desc: "Jalur Evakuasi"),
                      MenuWidget(redirect: TermsCondition(code: 'rumah_pompa'), img: 'assets/img/rumah_pompa.png', title: "Inspeksi Rumah Pompa", desc: "Rumah Pompa", 
                        checkInspect: dataCheckInspect(
                          link: "http://${globals.endpoint}/api_inspeksi_rumah_pompa.php?search",
                          text_belum_inspect: "Rumah Pompa Hydrant belum di inspeksi",
                          text_sudah_inspect: "Rumah Pompa Hydrant telah di inspeksi bulan ini!",
                        ),
                      ),
                    ],
                  ),
