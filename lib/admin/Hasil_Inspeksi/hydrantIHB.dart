...
class HasilHydrantIHB extends StatefulWidget {
  HasilHydrantIHB({super.key, this.restorationId});
  final String? restorationId;

  @override
  _HasilHydrantIHBState createState() => _HasilHydrantIHBState();
}


class _HasilHydrantIHBState extends State<HasilHydrantIHB> with RestorationMixin {
  @override
  ...
  List<String> titleColumn = [
    "id inspeksi", "Email Inspektor", "Lokasi Hydrant", "Kondisi Kotak", "Posisi Kotak", "Kondisi Nozzle", "Kondisi Selang", "Jenis Selang", "Kondisi Coupling", "Kondisi Landing Valve", "Kondisi Tray", "Durasi Inspeksi", "Tanggal Inspeksi", "Kondisi Kotak Image", "Posisi Kotak Image", "Kondisi Nozzle Image", "Kondisi Selang Image", "Jenis Selang Image", "Kondisi Coupling Image", "Kondisi Landing Valve Image", "Kondisi Tray Image"
  ];
  ...
  List<String> titleColumnExport = [
    "id inspeksi", "Email Inspektor", "Nomor Hydrant", "Lokasi Hydrant", "Kondisi Kotak", "Posisi Kotak", "Kondisi Nozzle", "Kondisi Selang", "Jenis Selang", "Kondisi Coupling", "Kondisi Landing Valve", "Kondisi Tray", "Durasi Inspeksi", "Tanggal Inspeksi", "Kondisi Kotak Image", "Posisi Kotak Image", "Kondisi Nozzle Image", "Kondisi Selang Image", "Jenis Selang Image", "Kondisi Coupling Image", "Kondisi Landing Valve Image", "Kondisi Tray Image"
  ];
